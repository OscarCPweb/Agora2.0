...
<?php
  ...
  if($c==null){
    ...
    $sql="SELECT id, hora, fecha, tarea, confirmacion, comentario FROM tareas WHERE id_usuario_tarea = '$id' ORDER BY fecha DESC";
    ...
    if($resultado){
      ...
      if($filas == 0){
        ...
        elseif(strcmp($registro['confirmacion'], $pendiente) == 0){
            echo "<div class='panel panel-info'><div class='panel-heading'>TAREA PENDINETE </div>";
        }
        else{
            echo "<div class='panel panel-warning'><div class='panel-heading'>TAREA PENDIENTE </div>";
        }
 ...
 ?>
 <form action="../inc/menu/tareas/validar-tareas.php" method="post">
