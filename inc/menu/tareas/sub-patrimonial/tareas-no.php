...
<?php
  ...
  if($c==null){
    ...
    $sql="SELECT id, hora, fecha, tarea, confirmacion, comentario FROM tareas WHERE id_usuario_tarea = '11' ORDER BY fecha DESC";
 ...
 ?>
 <form action="../inc/menu/tareas/campañas/validar-tareas.php" method="post">
