...
<div class="row inbox">
	<div class="col-md-3">
        ...
        <h4>Herrero Brigantina</h4>
          ...
          <li>
            <a href="archivos/campanas/resumenes/VIDA-AHORRO.xlsx"><i class='fa fa-calendar'></i> Campaña hasta hoy</a>
          </li>
          <li>
            <a href='../menus/empleados/empleados_patrimonial.php'><i class='fa fa-users'></i> Empleados</a>
          </li>
          <li>
            <a href='../acceso/cerrar_session.php'><i class='fa fa-trash-o'></i> Cerrar Sesión</a>
          </li>
          <div class="" style="display:none;" id="myAlert">
            <h2>Total Herrero Brigantina PATRIMONIAL</h2>
